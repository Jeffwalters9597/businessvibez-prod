-- Direct SQL operations to create buckets and policies
-- This avoids using storage extension functions that may not exist
...
EXCEPTION WHEN OTHERS THEN
  -- Ignore errors if table doesn't exist or other permission issues
